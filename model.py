...
class WSAD(Module):
    def __init__(self, input_size, flag, a_nums, n_nums, frame_window):
        super().__init__()
        self.flag = flag
        self.a_nums = a_nums
        self.n_nums = n_nums
